...
<div class="widget do_adminwidget" id="content-acl-role">
    ...
    <div class="widget-content">
        ...
        <div class="pull-right">
            <a href="javascript:void(0)" class="btn btn-xs btn-primary do_dialog" data-dialog="title: '{_ Help about ACL roles. _}', text: '{_ Users can be member of multiple roles. Depending on the roles an user is allowed to create and edit certain categories or is able to manage certain modules. _}'" title="{_ Need more help? _}"><i class="glyphicon glyphicon-question-sign"></i></a>
        </div>
                ...
                {% for mimes in [
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        {% for mime in mimes %}
                            ...
                            {% else %}
                                <li>
                                    <div class="checkbox"><label for="{{ #acl.mime }}">
