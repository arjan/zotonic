	...
	<div class="row">
		<div class="form-group col-lg-2 col-md-2">
			<label class="control-label" for="{{ #name_first }}">{_ First name _}</label>
				<div>
				<input class="form-control" id="{{ #name_first }}" type="text" name="name_first" value="{{ rcpt.props.name_first|default:r.name_first|default:q.name_first|escape }}" style="width: 90%;" />
			</div>
		</div>
		...
		<div class="form-group col-lg-1 col-md-1">
			<label class="control-label" for="{{ #name_surname_prefix }}">{_ Prefix _}</label>
					<div>
				<input class="form-control" id="{{ #name_surname_prefix }}" type="text" name="name_surname_prefix" value="{{ rcpt.props.name_surname_prefix|default:r.name_surname_prefix|default:q.name_surname_prefix }}" style="width: 50%" />
			</div>
			</div>
		...
		<div class="form-group col-lg-3 col-md-3">
			<label class="control-label" for="{{ #name_surname }}">{_ Surname _}</label>
				<div>
			<input class="form-control" id="{{ #name_surname }}" type="text" name="name_surname" value="{{ rcpt.props.name_surname|default:r.name_surname|default:q.name_surname|escape }}" style="width: 90%" />
			</div>
			</div>
